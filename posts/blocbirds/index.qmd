...
[<br>[Luscinia svecica volgae](https://en.wikipedia.org/wiki/Bluethroat#/media/File:Luscinia_svecica_volgae.jpg) by [Bogomolov.PL](https://commons.wikimedia.org/wiki/User:Bogomolov.PL), used under [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0)]{.aside}
...
The first few examples are all based on images I [from this site](https://www.birdspot.co.uk/bird-numbers/the-worlds-most-colourful-birds).
