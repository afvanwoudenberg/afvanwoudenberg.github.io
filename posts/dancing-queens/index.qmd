...
In this post, we'll explore how to solve the n-queens problem using Python and visualize solutions using Matplotlib. We'll also show how to create an animation from the solutions.

## Importing libraries

We start by importing the necessary libraries. The Matplotlib library will be used to display the chessboard and the queens.
...
Here's what the code for `solve_n_queens_()` looks like:
...
The `solve_n_queens()` function takes one parameter: n, the size of the board. It initializes the board to be empty and calls the `solve_n_queens_()` function with the board and the first row.

Here's what the code for `solve_n_queens()` looks like:
...
The following function takes an n-queens solution and an `ax` object as inputs and plots the solution on the given axes. It first defines colors for the squares of the chessboard and determines the size of the board. It then draws the squares of the chessboard and the chess pieces using loops, sets the aspect ratio to "equal", removes the tick labels from the axes, and flips the y-axis. The result is a visualization of the n-queens solution on the given axes.
...
If the board size is larger, plotting all possible solutions would require a significant amount of space. To address this issue, the following code generates widgets that enable you to choose a board size and iterate through the solutions.
...
I originally created this code to teach my students about the concept of backtracking. I hope that it will be helpful for you as well.

Use one of the following links to play with an interactive version:

<a target="_blank" href="https://mybinder.org/v2/gist/afvanwoudenberg/5b13ecc612327bb22922d803d9071497/HEAD">![Binder](https://mybinder.org/badge_logo.svg)</a>
<a target="_blank" href="https://kaggle.com/kernels/welcome?src=https://gist.githubusercontent.com/afvanwoudenberg/5b13ecc612327bb22922d803d9071497/raw/c9340803678cc8eafe2b8796ecbd8097bf4e23b5/N-Queens.ipynb">![Kaggle](https://kaggle.com/static/images/open-in-kaggle.svg)</a> 
<a target="_blank" href="http://colab.research.google.com/gist/afvanwoudenberg/5b13ecc612327bb22922d803d9071497/N-Queens.ipynb">![Colab](https://colab.research.google.com/assets/colab-badge.svg)</a>
<a target="_blank" href="https://gist.github.com/afvanwoudenberg/5b13ecc612327bb22922d803d9071497">![GitHub](https://shields.io/badge/-View%20as%20Gist-grey.svg?logo=github&style=flat&logoColor=white&labelColor=black)</a>
